        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">4.1 גווני צבע וחזות המוצר</h3>
              <p className="text-gray-600 mb-4">
                הגוונים, המרקמים והמראה הכללי של המוצרים המוצגים באתר הם לצורכי המחשה בלבד. ייתכנו הבדלים בין התמונות באתר לבין המוצר בפועל, הנובעים מאופן הצילום, תנאי תאורה, הגדרות הצג של המשתמש, וכן מתהליכי ייצור ואריגה של השטיחים. הבדלים סבירים בגוון, במרקם או בדוגמה אינם מהווים פגם במוצר ואינם מקנים זכות להחזרה, החלפה או פיצוי מעבר לאמור בסעיף 3 לעיל.
              </p>
            </section>
