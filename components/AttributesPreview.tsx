...
const fallbackImage = 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&q=80';

export default function AttributesPreview({ categories, spaces, shapes = [], categoryImages = {}, spaceImages = {}, shapeImages = {} }: AttributesPreviewProps) {
  ...
  const displayShapes = shapes.slice(0, 4);
    ...
    <section className="section-spacing bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden pattern-chevron-subtle">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {displayShapes.length > 0 && (
          <div className="mb-12">
            <h3 className="text-2xl font-bold text-gray-800 mb-6 text-right">צורות</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
