        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className="hidden md:flex items-center space-x-4 space-x-reverse md:ms-4 lg:ms-6">
            ...
            <SearchAutocomplete
              ...
              inputClassName="w-full pl-9 pr-4 py-2 text-sm border border-gray-300 rounded-full bg-gray-50 focus:bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-all"
              iconClassName="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm pointer-events-none"
            />
            {/* Social Media Icons */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4 animate-fade-in">
            ...
            <div className="mb-4 px-4">
              <SearchAutocomplete
                inputClassName="w-full pl-10 pr-4 py-3 text-sm border border-gray-300 rounded-full bg-gray-50 focus:bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition-all"
                iconClassName="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"
